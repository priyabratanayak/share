...
def main(capital):
    ...
    #postion data frame pos_df tells you all the positions you have taken throughout the day
    ...
    while a < 10:
        try:
            ...
            a+=1
    #Order data frame ord_df tells you all the orders you have placed throughout the day
    while b < 10:
        try:
...
capital = 3000 #position size. What is the maximum amount you want to trade for each position
