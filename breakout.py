...
for ticker in tickers:
    ...
    #09.35  becuase candle forms after 5 min
...
for ticker in tickers:
    ...
    ohlc_dict[ticker]["roll_max_cp"] = ohlc_dict[ticker]["High"].rolling(20).max()#rolling max close prize
...
strategy_df["ret"] = strategy_df.mean(axis=1) #to allocate fund we need to get the mean return
CAGR(strategy_df)
